				      ...
				      $a_nombre = trim($_POST['a_nombre']);
						  ...
						  $sonletras = num2letras($total);
							...
							if($tipo_entrega == '1'){
								...
								if($pagado == '1'){
										$funcion->Insertar_conduce($a_nombre, 'AL CONTADO', $entrega,
						        $sumas, $iva, $exento, $retenido, $descuento, $total, $sonletras, $_SESSION['user_id'], $idcliente);
								} else if ($pagado == '0') {
				            $funcion->Insertar_conduce($a_nombre, 'AL CREDITO', $entrega,
				            $sumas, $iva, $exento, $retenido, $descuento, $total, $sonletras, $_SESSION['user_id'], $idcliente);
								}
				          ...
				          $funcion->Insertar_Detalleconduce($idproducto, $cantidad, $disponible, $precio_unitario, $exentos, $descuento, $importe);
							...
							case 'Borrar':
								...
								$funcion->Borrar_conduce($numero_transaccion);
							break;
