<?php
	...
	$idconduce = isset($_GET['numero_transaccion']) ? $_GET['numero_transaccion'] : '';

	$objconduce =  new conduce();
	$detalle = $objconduce->Listar_Detalle($idconduce);
		...
		<div class="panel">
            ...
            <table class="table table-xxs table-bordered">
             ...
             <tr>
              ...
              <td width="35%"><?php echo $numero_conduce; ?></td>
            ...
            <tr>
              ...
              <td width="30%"><?php echo DateTime::createFromFormat('Y-m-d H:i:s', $fecha_conduce)->format('d/m/Y H:i:s'); ?></td>
            </tr>
            <tr>
