...
function detalle_conduce(VentaNo)
{
    $.ajax({

       type:"GET",
       url:"web/ajax/reload-detalle-conduce.php?numero_transaccion="+VentaNo,
  ...
  var fecha2 = $("#txtF2").val();
    ...
    if(fecha1!="" && fecha2!="")
    {
        $.ajax({
           ...
           type:"GET",
           url:"web/ajax/reload-verconduce.php?fecha1="+fecha1+"&fecha2="+fecha2,
           success: function(data){
      ...
      $.ajax({
           ...
           type:"GET",
           url:"web/ajax/reload-verconduce.php?fecha1=empty&fecha2=empty",
           success: function(data){
              $('#reload-div').html(data);
           }
...
function SwalDelete(productId){
              swal({
                title: "¿Está seguro que desea borrar el Conduce?",
...
{
  window.open('reportes/conduce.php?conduce='+btoa(Criterio),
  'win2',
