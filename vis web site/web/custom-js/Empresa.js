...
function newEmpresa()
 {
    openEmpresa('nuevo',null,null,null,null);
    $('#modal_iconified').modal('show');
 }
function openEmpresa(action,idEmpresa,nombre,RNC,estado)
 {
    ...
    $('#modal_iconified').on('shown.bs.modal', function () {
     ...
     if (action == 'nuevo'){
      ...
      modal.find('.title-form').text('Ingresar Empresa de Productos');
      ...
      modal.find('.title-form').text('Actualizar Empresa de Productos');
     } else if(action=='ver'){
      $('#txtProceso').val('');
      $('#txtID').val(idEmpresa);
      $('#txtEmpresa').val(nombre);
      ...
      modal.find('.title-form').text('Ver Empresa de Productos');
     }
...
function enviar_frm()
{
  var urlprocess = 'web/ajax/ajxEmpresa.php';
  ...
  var dataString='proceso='+proceso+'&id='+id+'&Empresa='+Empresa+'&RNC='+RNC+'&estado='+estado;
     ...
     success: function(data){
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              cargarDiv("#reload-div","web/ajax/reload-Empresa.php");
              limpiarform();
