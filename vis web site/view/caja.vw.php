						...
						<div class="panel-heading">
							...
							<div class="heading-elements">
	                            ...
	                            <div class="btn-group heading-btn">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										<li><a id="print_diario" href="javascript:void(0)"><i class="icon-flag8 pull-right"></i> Cierre de Caja - Diario</a></li>
										<li><a id="print_mes" href="javascript:void(0)"><i class="icon-flag7 pull-right"></i> Cierre de Caja	 - Mensual</a></li>
									</ul>
	                            </div>
