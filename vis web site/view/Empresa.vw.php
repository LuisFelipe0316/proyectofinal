			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Empresas de Comprobantes</li>
					</ul>
				</div>
					<div class="panel-heading">
						<h5 class="panel-title">Empresas De Comprobantes</h5>
					...
					<table class="table datatable-basic table-xxs table-hover">
						...
						<tbody>
						  ...
						  <?php
								$filas = $objEmpresa->Listar_Empresa();
								...
								?>
									<tr>
					                	<td><?php print($column['idEmpresa']); ?></td>
					                	<td><?php print($column['nombre_Empresa']); ?></td>
					                	<td><?php print($column['RNC']); ?></td>
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													onclick="openEmpresa('editar',
								                     '<?php print($column["idEmpresa"]); ?>',
								                     '<?php print($column["nombre_Empresa"]); ?>',
								                     '<?php print($column["RNC"]); ?>',
								                     '<?php print($column["estado"]); ?>')">
												   <i class="icon-pencil6">
											       </i> Editar</a></li>
													<li><a
													href="javascript:;" data-toggle="modal" data-target="#modal_iconified"
													onclick="openEmpresa('ver',
								                     '<?php print($column["idEmpresa"]); ?>',
								                     '<?php print($column["nombre_Empresa"]); ?>',
								                     '<?php print($column["RNC"]); ?>',
								                     '<?php print($column["estado"]); ?>')">
					        ...
					        <form role="form" autocomplete="off" class="form-validate-jquery" id="frmModal">
								...
								<div class="alert alert-info alert-styled-left text-blue-800 content-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-8">
												<label>Empresas De Comprobantes <span class="text-danger">*</span></label>
												<input type="text" id="txtEmpresa" name="txtEmpresa" placeholder="Traikor SRL"
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-8">
												...
												<input type="number" min="9" max="11" id="txtEmpresa" name="txtEmpresa" placeholder="131640389"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
...
<script type="text/javascript" src="web/custom-js/Empresa.js"></script>
<?php } else { ?>
