			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Comprobantes Fiscales</li>
					</ul>
				</div>
					<div class="panel-heading">
						<h5 class="panel-title">Comprobantes Fiscales</h5>
								...
								<div class="alert alert-info alert-styled-left text-blue-800 content-group">
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-5">
												<label>Fecha y Hora Comprobantes <span class="text-danger">*</span></label>
