					...
					<div class="panel panel-flat">
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
								...
								<li><a href="javascript:;">PREVENTA</a></li>
								<li class="active">Preventa del Dia</li>
							</ul>
						</div>
						<div class="panel-heading">
							<h6 class="panel-title">Preventa del Dia - <?php echo
							...
							<div class="tabbable">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="label-tab1">
										...
										<div class="panel panel-flat">
											<div class="panel-heading">
												<h5 class="panel-title">Preventa Vigentes</h5>
												<div class="heading-elements">
                                ...
                                $fecha_limite_retiro = $column["fecha_limite_retiro"];
									...
									<div class="tab-pane" id="label-tab2">
										...
										<div class="panel panel-flat">
											<div class="panel-heading">
												<h5 class="panel-title">Preventa Anulados</h5>
												<div class="heading-elements">
                              ...
                              <?php
                                ...
                                ?>
									...
									<div class="tab-pane" id="label-tab3">
										...
										<div class="panel panel-flat">
											<div class="panel-heading">
												<h5 class="panel-title">Preventa Finalizados</h5>
												<div class="heading-elements">
	...
	<div id="modal_detalle" class="modal fade">
		<div class="modal-dialog modal-full">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h5 class="modal-title"></i> &nbsp; <span class="title-form text-uppercase">Detalle de Preventa</span></h5>
				</div>
								...
								<div class="panel">
									<div class="panel-heading bg-info">
										<h6 class="panel-title">
											<a class="collapsed" data-toggle="collapse" href="#collapsible-control-right-group2">Clic para ver Información del Preventa</a>
										</h6>
									</div>
										...
										<div class="panel-body">
											<div class="table-responsive">
												<table class="table table-xxs table-bordered">
												 ...
												 <tr>
												 	<td width="5%" class="text-bold text-left">NO. PREVENTA</td>
													<td width="35%"></td>
												...
												<tr>
													...
													<td width="30%"></td>
													<td width="2%" class="text-bold text-left">FECHA PREVENTA</td>
													<td width="30%"></td>
												</tr>
												<tr>
