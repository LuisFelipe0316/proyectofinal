									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" id="txtNombre" name="txtNombre" placeholder="EJ. LUIS"
												 class="form-control" style="text-transform:uppercase;"
											...
											<div class="col-sm-6">
												...
												<input type="text" id="txtApellido" name="txtApellido" placeholder="EJ. MARTINEZ"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" id="txtTelefono" name="txtTelefono" placeholder="EJ. 829-569-2686"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
