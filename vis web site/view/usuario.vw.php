									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" id="txtUser" name="txtUser" placeholder="EJ. LUIS"
												class="form-control">
											</div>
											...
											<div class="col-sm-6">
												...
												<select  data-placeholder="..." id="cbTipo" name="cbTipo"
				                            		...
				                            		onkeyup="javascript:this.value=this.value.toUpperCase();">
														...
														<option value="4">DESPACHADOR/A</option>
														<option value="5">ASISTENTE ADMINISTRADOR/A</option>
														<option value="6">EJECUTIVOS/A</option>
