			      	...
			      	<!-- Detalle de Compra -->
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">Generar Conduce de Productos</h4>
									...
									<table id="tbldetalle" class="table table-xxs">
										...
										<tfoot id="totales_foot">
											<tr class="bg-info-800">
												...
												<td align="center" width="26%">ITEBIS </td>
												<td align="center" width="10%">SUBTOTAL</td>
												<td align="center" width="10%">RET. (-)</td>
												<td align="center" width="10%">TOT. SIN ITEBIS</td>
											...
											<tr>
												...
												<td align="center" id="itebis"></td>
												<td align="center" id="subtotal"></td>
												<td align="center" id="itebisretenido"></td>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h5 class="modal-title"><i class="icon-file-text2"></i> &nbsp; <span class="title-form">Datos de Conduce</span></h5>
							</div>
...
<script type="text/javascript" src="web/custom-js/conduce.js"></script>
