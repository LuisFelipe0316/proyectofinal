				...
				<div id="modal_iconified" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-12">
												...
												<input type="text" id="txtNombre" name="txtNombre" placeholder="EJ. LUIS MARTINEZ / DATA TRAVEL"
												 class="form-control" style="text-transform:uppercase;"
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<input type="text" id="txtNIT" name="txtNIT" placeholder="EJ. 402-2938605-8"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
											...
											<div class="col-sm-6">
												<label>RNC</label>
												<input type="text" id="txtNRC" name="txtNRC" placeholder="EJ. 131640381"
												 class="form-control" style="text-transform:uppercase;"
																						onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" id="txtTelefono" name="txtTelefono" placeholder="EJ. 829-569-2696"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
											...
											<div class="col-sm-6">
												<label>Email</label>
												<input type="email" id="txtEmail" name="txtEmail" placeholder="EJ. felipe020316@gmail.com"
												 class="form-control">
											</div>
										</div>
									</div>
                           ...
                           placeholder="EJ. CALLE FRANK DIAZ #4, Santo Domingo - Rep Dom"
