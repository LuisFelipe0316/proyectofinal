<?php
	...
	$pdf->AddPage();
		...
		$pdf->Text(4, $get_YH  + 5, 'No. Conduce: '.$numero_apartado);
		$pdf->Text(55, $get_YH + 5, 'Caja No.: 1');
		$pdf->Text(4, $get_YH + 10, 'Fecha Conduce: '.$fecha_apartado);
    ...
    $pdf->MultiCell(65, 4.2, utf8_decode('* Recuerde que tiene un total de: '.$diferencia.' dias (hasta el '.$fecha_limite_retiro.'),
		para poder saldar su facturas. De caso contrario este quedara anulado y el producto puede agotarse en existencias *'), 0,'C',0 ,1);
