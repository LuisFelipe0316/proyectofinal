...
CREATE  PROCEDURE `sp_insert_Empresa` (IN `p_nombre_Empresa` VARCHAR(120), IN `p_RNC` VARCHAR(11))   BEGIN
  IF NOT EXISTS (SELECT * FROM `Empresa` WHERE `nombre_Empresa` = p_nombre_Empresa) THEN
	INSERT INTO `Empresa`(`nombre_Empresa`,`RNC`)
	VALUES (p_nombre_Empresa,p_RNC);
  END IF;
END$$
...
CREATE  PROCEDURE `sp_update_Empresa` (IN `p_idEmpresa` INT(11), IN `p_nombre_Empresa` VARCHAR(120), IN `p_RNC` VARCHAR(45), IN `p_estado` TINYINT(1))   BEGIN
UPDATE `Empresa`
...
(1, 'Dop', 'DO', 'Peso Dominicano', 'DO', 'RD$'),
(2, 'USD', 'EN', 'Dolar Estadounidense', 'US.Dolar', '$'),
(3, 'DOP', 'DO', 'Peso Domnicano', 'DO', 'RD$');
...
(1, 'EM00000001', 'EMPLEADO', 'TIENDA', '8098266686', 'ferreteriacanguro@gmail.com', 1, NULL);
...
(1, 'FERRETERIA EL CANGURO', 'FERRETERIA EL CANGURO', '0', '0', '1.00', '0.00', '0.00', 'AV. HIPICA ESQ. MARIA TRINIDA SANCHEZ #63 \nBRISA DEL ESTE.', NULL, 1);
...
CREATE TABLE `Empresa` (
  ...
  `nombre_Epresa` varchar(120) NOT NULL,
...
INSERT INTO `Empresa` (`idEmpresa`, `nombre_Empresa`, `RNC`, `estado`) VALUES
(1, 'Inverisap SRL', '131640389', 1);
